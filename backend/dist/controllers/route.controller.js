...
class RouteController {
    ...
    async trazarRuta(req, res) {
        try {
            ...
            const result = await routeService.trazarRuta(parsed.data.origen_lat, parsed.data.origen_lng, parsed.data.destino_id, parsed.data.destino_lat !== undefined && parsed.data.destino_lng !== undefined
                ? {
