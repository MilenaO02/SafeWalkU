...
const swaggerSpec = {
    ...
    paths: {
        ...
        "/routes/trazar": { get: operation("Calcular trayecto hacia un destino seguro", { tags: ["Rutas"], roles: ["ESTUDIANTE", "ADMINISTRADOR"], parameters: [{ name: "origen_lat", in: "query", required: true, schema: { type: "number", minimum: -90, maximum: 90 } }, { name: "origen_lng", in: "query", required: true, schema: { type: "number", minimum: -180, maximum: 180 } }, { name: "destino_id", in: "query", required: true, schema: { type: "integer", minimum: 1 } }], responses: { 200: response("Trayecto calculado o referencia identificada"), ...errors(400, 401, 403, 404, 422, 500) } }) },
        "/routes/{id}": {
