...
const errors = (...codes) => Object.fromEntries(codes.map((code) => [code, response(errorDescriptions[code], { $ref: "#/components/schemas/ApiError" })]));
...
const jsonBody = (schema) => ({ required: true, content: jsonContent(schema) });
