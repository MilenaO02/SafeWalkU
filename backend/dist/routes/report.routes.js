 ...
 */
router.post("/", auth, authorize("ESTUDIANTE", "ADMINISTRADOR"), validate(createReportSchema), reportController.create);
/**
 * @swagger
 * /api/reports/{id}:
 *   put:
 ...
 */
router.put("/:id", auth, authorize("ADMINISTRADOR"), validate(updateReportSchema), reportController.update);
/**
 * @swagger
 * /api/reports/{id}:
 *   delete:
 ...
 */
router.delete("/:id", auth, authorize("ADMINISTRADOR"), reportController.delete);
/**
 * @swagger
 ...
 */
router.patch("/:id/restaurar", auth, authorize("ADMINISTRADOR"), reportController.restore);
