 ...
 *       - bearerAuth: []
 */
router.get("/:id", auth, authorize("ADMINISTRADOR"), controller.getById);
/**
 * @swagger
 * /users/me:
 *   put:
 ...
 *       - bearerAuth: []
 */
router.put("/me", auth, validate(updateOwnProfileSchema), controller.updateMe);
/**
 * @swagger
 * /users/{id}:
 *   put:
 ...
 *       - bearerAuth: []
 */
router.put("/:id", auth, authorize("ADMINISTRADOR"), validate(updateUserSchema), controller.update);
/**
 * @swagger
 * /users/{id}:
 *   delete:
