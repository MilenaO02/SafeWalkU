...
export function evidenceTypeFromMime(mimeType: string): "IMAGEN" | "VIDEO" {
    return mimeType.startsWith("image/") ? "IMAGEN" : "VIDEO";
}

export async function hasValidEvidenceSignature(filePath: string, mimeType: string): Promise<boolean> {
